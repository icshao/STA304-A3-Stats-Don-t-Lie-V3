...
$$log(\frac{p}{1-p})= \beta_{0} + \beta_{ethnicity}x_{ethnicity \ i} + \beta_{gender}x_{gender\ i}  + \beta_{education}x_{education \ i}+ \beta_{employment}x_{employment\ i} +  \beta_{age}x_{age\ i}$$
...
```{r echo=FALSE, fig.cap="Histogram of Prediction values", fig.height=3, fig.width=6}
census_data_predict %>%
...
Going to fix the format for these: 
...
Alexander, R and Caetano, S. (2020). *“01-data_cleaning-survey1”*. STA304, University of Toronto

Alexander, R and Caetano, S. (2020). *“01-data_cleaning-post-strat1”*. STA304, University of Toronto 
